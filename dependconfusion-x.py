...
class DependencyConfusion:
    ...
    def __init__(self, urls_file, threads, slack_option):
        self.dependencies_names = ['dependencies',
                ...
                for name in self.dependencies_names:
                    try:
                        ...
                        for package in depen:
                            check = requests.get(
                                "https://registry.npmjs.org/-/v1/search?text="+package)
    ...
    def main(self):
        ...
        msg = "\n[++] We started scanning " + total_hosts + \
            " targets for Dependency Confusion ...\n"
        ...
        msg = "\n[++] We finished scanning " + total_hosts + \
            " targets for Dependency Confusion ...\n"
        print('-'*70)
        self.print_result(Fore.GREEN, msg)
        if self.slack_option:
...
banner = pyfiglet.figlet_format(
    "DependaCon - X  T o o l", width=130,  justify='center')
print(Fore.GREEN+'\n \n'+banner)
print('Developed By @Alifathi-h1 \n\n '.center(90))


parser = argparse.ArgumentParser(
    description='DependConfusion-X Tool is written in Python3 that scans and monitors list of hosts for Dependency Confusion.\n\n')
